  ...
  const agents = [
    {
      ...
      action: "Test Website Sales Agent"
    },
    {
            ...
            <div key={idx} className={`glass-panel p-8 md:p-12 rounded-3xl relative overflow-hidden reveal-up group border border-white/5 hover:border-white/10 transition-colors bg-card/30`}>
              ...
              <div className="relative z-10 grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div className="bg-black/20 rounded-2xl p-6 border border-white/5">
                  ...
                  <Link
                    href={agent.href}
                    className="mt-6 inline-flex items-center justify-center rounded-lg bg-white px-4 py-2 text-sm font-medium text-black transition-colors hover:bg-white/90"
                  >
                    {agent.action}
                  </Link>
                </div>
