    ...
    <div className="bg-background min-h-screen pt-32 pb-20" ref={containerRef}>
      <div className="container mx-auto px-6 max-w-6xl">
        <div className="text-center mb-24">
          ...
          <AnimatedHeadline text="Done-For-You Solutions" as="h1" className="text-5xl md:text-7xl text-white mb-6 justify-center font-display font-bold tracking-tighter" />
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-24">
          {services.map((service, idx) => (
            <div key={idx} className={`glass-panel p-10 rounded-3xl reveal-up border border-white/5 hover:border-primary/30 transition-colors bg-card/30 ${idx === 4 ? 'md:col-span-2' : ''}`}>
        ...
        <div className="glass-panel p-12 rounded-3xl text-center reveal-up border border-primary/20 bg-primary/5">
          <h3 className="text-3xl font-display font-bold text-white mb-4 tracking-tight">Need a custom architecture?</h3>
